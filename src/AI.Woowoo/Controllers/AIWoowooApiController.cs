...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "AI.Woowoo")]
    public class AIWoowooApiController : AIWoowooApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public AIWoowooApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
